...
use ash::{extensions::khr, vk::{self, FormatFeatureFlags}};
...
impl PhysicalDeviceFeatures {
    ...
    fn to_wgpu(
        ...
        features.set(F::BGRA8UNORM_STORAGE, supports_bgra8unorm_storage(instance, phd, caps.effective_api_version));
...
fn supports_bgra8unorm_storage(
    ...
    unsafe {
        ...
        let vk_1_3 = api_version >= vk::API_VERSION_1_3;

        // PHYSICAL_DEVICE_PROPERTIES_3 is not defined in (this version of) ash.
        // From https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html
        const PHYSICAL_DEVICE_PROPERTIES_3: vk::StructureType = vk::StructureType::from_raw(1000360000);

        let mut properties3 = vk::FormatProperties3 {
            s_type: PHYSICAL_DEVICE_PROPERTIES_3,
        ...
        let mut properties2 = vk::FormatProperties2 {
            ...
            p_next: if vk_1_3 {
                std::mem::transmute(&mut properties3)
            } else {
                std::ptr::null_mut()
            },
        ...
        let vk_1_3_reequirements = features3.contains(vk::FormatFeatureFlags2::STORAGE_READ_WITHOUT_FORMAT_KHR)
            && features3.contains(vk::FormatFeatureFlags2::STORAGE_WRITE_WITHOUT_FORMAT_KHR);

        base_requirements && (!vk_1_3 || vk_1_3_reequirements)
    }
}
